 ...
 */
export const ITEST_REDIS_KEY = 'marketplaceDev:itest:adminAuthenticatedAuthorization:'
 ...
 * asserting nothing the single-key case does not already prove; the rotation suite seeds its own.
 */

		...
		projects: [
			...
			},
			{
				...
				test: {
					...
					env: {
						NODE_ENV: 'test',
						// ⚠️ Imported, not written here: globalSetup seeds the keygrip record (ADR-034) from
						// another process, into `${REDIS_KEY}keygrip`, and a prefix typed twice is a prefix
